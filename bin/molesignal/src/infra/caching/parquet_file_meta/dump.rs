...
use crate::{
    ...
    domain::{
        storage::{
            ParquetFileMeta, ParquetFileMetaDumpCache as ParquetFileMetaDumpCachePort,
            ParquetFileMetaDumpRow, PartitionLevel, PhysicalDatasetKind,
        },
        stream::StreamType,
    },
    shared::ids::Id,
...
#[async_trait]
impl ParquetFileMetaDumpCachePort for ParquetFileMetaDumpCache {
