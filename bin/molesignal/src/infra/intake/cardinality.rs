...
//! Prometheus active-series admission for the current consistent-hash intake owner.
//!
...
/// Process-local registry shared by every remote-write handler on an intake.
