...
pub fn routes() -> Router<AppState> {
    Router::new()
        .route("/agent/dashboard-authoring/capabilities", get(capabilities))
        .route("/agent/dashboard-drafts/{id}", get(get_draft))
        .route("/agent/dashboard-drafts/{id}/propose", post(propose))
}
