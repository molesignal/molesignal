...
export type ProfileEditorTarget = {
  profile: agentApi.AgentProfile | 'new';
...
interface ProfileDraft {
  ...
  services: string;
  streams: string;
  networkAccess: agentApi.NetworkAccess;
...
function profileDraft(
  target: agentApi.AgentProfile | 'new',
...
export function ProfileEditorDrawer({
  ...
  const save = useMutation({
    mutationFn: ({
      ...
      id
        ? agentApi.updateProfile(id, input)
        : agentApi.createProfile(input),
