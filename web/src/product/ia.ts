...
import { SYNTHETICS_PRODUCT_ROUTES } from './ia/synthetics';
...
export const PRODUCT_NAV_GROUP_META = {
  ...
  observe: { labelKey: 'groups.observe', icon: ScrollText },
  reliability: { labelKey: 'groups.reliability', icon: ShieldCheck },
  ai_ops: { labelKey: 'groups.ai_ops', icon: Bot },
