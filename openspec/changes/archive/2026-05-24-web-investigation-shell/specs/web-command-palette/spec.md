...
- **THEN** exactly one row carries the selected state (2px accent border on its left edge), and the list scrolls to keep that row in the viewport center band
