# Web Trace Flame View

## Purpose

Canvas-based flame / waterfall renderer for traces up to 100k spans: DPR-adaptive draw, <1px span culling, O(log n) hit-test, `/` in-trace search with `n/N` jump, `f/w` mode toggle.
