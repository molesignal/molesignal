# Web Org Switching Capability

## Purpose

Front-end org listing, current-org tracking, and switcher UI so authenticated users can list every org they belong to and switch between them from the shell's StatusStrip without needing to re-login.
