...
Virtualized log row viewer powered by TanStack Virtual: 1M-row buffer, NDJSON live tail with sticky-bottom + new-rows badge, level / service color, `j/k/G/gg/Enter/⌘C/\` keyboard nav, off-thread substring search worker.
