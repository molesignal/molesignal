...
Expose three orthogonal UI preference axes — theme, palette, and density — wired through CSS data attributes, persisted in localStorage, surfaced in the StatusStrip Settings dropdown, and gated by an automated WCAG AA contrast check so new palettes cannot regress accessibility.
