...
pub mod infra {
    pub mod persistence {
        pub use postgres::sqlx_err;
    }
}

pub mod shared {
    pub use kernel::{Result, ids, time};
    pub use signals::trace_normalization;
}
...
/// Returns the canonical service identity used by both live and recomputed graph edges.
