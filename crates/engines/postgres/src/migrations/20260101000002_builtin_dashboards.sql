...
VALUES
    ...
    ('544194a6-12c8-410e-8d8c-99ce409aedc8', 'molesignal-intake-storage', 'MoleSignal Intake & Storage', 'Complete intake, WAL, object I/O, manifest, Catalog, compaction, indexing, and maintenance metrics.', $tags$["built-in","molesignal","system","intake","storage"]$tags$::JSONB, 2, FALSE),
    ...
    ('6739830b-8667-4eba-8506-46a9284ae0fb', 'molesignal-cache-search-federation', 'MoleSignal Cache, Search & Federation', 'Complete cache, Tantivy search, and cross-cluster federation metrics.', $tags$["built-in","molesignal","system","cache","search","federation"]$tags$::JSONB, 2, FALSE)
),
...
VALUES
    ...
    ('molesignal-intake-storage', 1, 'prometheus_active_series', 'gauge', '', 'short'),
    ('molesignal-intake-storage', 2, 'prometheus_remote_write_structural_rejections_total', 'counter', 'reason', 'ops/s'),
    ('molesignal-intake-storage', 3, 'prometheus_series_admission_rejections_total', 'counter', 'reason', 'ops/s'),
    ('molesignal-intake-storage', 4, 'intake_adaptive_rotation_target_bytes', 'histogram', 'dataset_type', 'bytes'),
    ('molesignal-intake-storage', 5, 'intake_buffer_reserved_bytes', 'gauge', '', 'bytes'),
    ('molesignal-intake-storage', 6, 'intake_flush_errors_total', 'counter', 'step', 'ops/s'),
    ('molesignal-intake-storage', 7, 'intake_flush_inflight', 'gauge', 'stream_type', 'short'),
    ('molesignal-intake-storage', 8, 'intake_memory_rejections_total', 'counter', 'stream_type', 'ops/s'),
    ('molesignal-intake-storage', 9, 'intake_parquet_encoded_raw_ratio', 'histogram', 'dataset_type', 'short'),
    ('molesignal-intake-storage', 10, 'intake_rotations_total', 'counter', 'stream_type,reason', 'ops/s'),
    ('molesignal-intake-storage', 11, 'wal_append_inflight', 'gauge', 'dataset_type', 'short'),
    ('molesignal-intake-storage', 12, 'wal_append_lock_wait_seconds', 'histogram', 'dataset_type', 'seconds'),
    ('molesignal-intake-storage', 13, 'wal_fsync_errors_total', 'counter', 'kind', 'ops/s'),
    ('molesignal-intake-storage', 14, 'object_store_bytes_total', 'counter', 'backend,op', 'bytes/s'),
    ('molesignal-intake-storage', 15, 'object_store_errors_total', 'counter', 'backend,op,reason', 'ops/s'),
    ('molesignal-intake-storage', 16, 'object_store_health_check_duration_seconds', 'histogram', 'backend', 'seconds'),
    ('molesignal-intake-storage', 17, 'object_store_op_duration_seconds', 'histogram', 'backend,op', 'seconds'),
    ('molesignal-intake-storage', 18, 'object_store_operations_total', 'counter', 'backend,op', 'ops/s'),
    ('molesignal-intake-storage', 19, 'object_read_requests_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 20, 'object_read_bytes_total', 'counter', '', 'bytes/s'),
    ('molesignal-intake-storage', 21, 'object_read_duration_seconds', 'histogram', '', 'seconds'),
    ('molesignal-intake-storage', 22, 'compactor_failures_total', 'counter', 'reason', 'ops/s'),
    ('molesignal-intake-storage', 23, 'compactor_merged_groups_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 24, 'compactor_retention_deleted_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 25, 'compactor_downsampled_partitions_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 26, 'wal_recovery_quarantined_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 27, 'wal_recovery_tail_truncated_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 28, 'index_build_duration_seconds', 'histogram', '', 'seconds'),
    ('molesignal-intake-storage', 29, 'index_rebuilt_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 30, 'index_rebuild_failed_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 31, 'partition_manifest_load_duration_seconds', 'histogram', '', 'seconds'),
    ('molesignal-intake-storage', 32, 'partition_manifest_corrupt_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 33, 'object_gc_delete_duration_seconds', 'histogram', '', 'seconds'),
    ('molesignal-intake-storage', 34, 'object_gc_deleted_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 35, 'object_gc_failed_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 36, 'object_gc_safety_rejections_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 37, 'storage_reconciler_issues_total', 'counter', 'kind,reason', 'ops/s'),
    ('molesignal-intake-storage', 38, 'storage_worker_healthy', 'status', 'worker', 'short'),
    ...
    ('molesignal-cache-search-federation', 5, 'object_cache_hit_bytes_total', 'counter', '', 'bytes/s'),
    ('molesignal-cache-search-federation', 6, 'object_cache_miss_bytes_total', 'counter', '', 'bytes/s'),
    ('molesignal-cache-search-federation', 7, 'object_cache_corrupt_blocks_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 8, 'object_cache_evictions_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 9, 'object_cache_singleflight_waiters', 'gauge', '', 'short'),
    ('molesignal-cache-search-federation', 10, 'object_cache_disk_bytes', 'gauge', '', 'bytes'),
    ('molesignal-cache-search-federation', 11, 'cache_tantivy_footer_errors_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 12, 'cache_tantivy_footer_evictions_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 13, 'cache_tantivy_footer_hit_ratio', 'ratio', '', 'percentunit'),
    ('molesignal-cache-search-federation', 14, 'cache_tantivy_footer_hits_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 15, 'cache_tantivy_footer_misses_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 16, 'cache_tantivy_result_errors_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 17, 'cache_tantivy_result_evictions_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 18, 'cache_tantivy_result_hit_ratio', 'ratio', '', 'percentunit'),
    ('molesignal-cache-search-federation', 19, 'cache_tantivy_result_hits_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 20, 'cache_tantivy_result_misses_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 21, 'tantivy_pruned_files_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 22, 'tantivy_puffin_blob_range_reads_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 23, 'tantivy_puffin_directory_open_seconds', 'histogram', '', 'seconds'),
    ('molesignal-cache-search-federation', 24, 'tantivy_puffin_directory_open_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 25, 'tantivy_puffin_footer_bytes_read_total', 'counter', '', 'bytes/s'),
    ('molesignal-cache-search-federation', 26, 'federated_search_auth_errors_total', 'counter', 'cluster', 'ops/s'),
    ('molesignal-cache-search-federation', 27, 'federation_events_applied_total', 'counter', 'result', 'ops/s'),
    ('molesignal-cache-search-federation', 28, 'federation_events_pushed_total', 'counter', '', 'ops/s'),
    ('molesignal-cache-search-federation', 29, 'federation_outbox_lag', 'gauge', 'cluster', 'short'),
    ('molesignal-cache-search-federation', 30, 'federation_push_errors_total', 'counter', 'cluster', 'ops/s')
),
overview_panel_seed (
...
VALUES
    ('molesignal-system-overview', 1, 'overview-self-telemetry-throughput', 'Self-telemetry throughput', 'Records accepted for durable self-telemetry intake.', 0, 0, 6, 16, 'stat', 'ops/s', 2, 0, NULL, $queries$[{"refId":"A","enabled":true,"dataSourceType":"metrics","legend":"Accepted","query":{"language":"promql","expression":"sum(rate(self_telemetry_accepted_total[5m]))"}}]$queries$::JSONB),
    ('molesignal-system-overview', 2, 'overview-self-telemetry-drops', 'Self-telemetry drops', 'Records dropped before durable intake.', 6, 0, 6, 16, 'stat', 'ops/s', 2, 0, NULL, $queries$[{"refId":"A","enabled":true,"dataSourceType":"metrics","legend":"Dropped","query":{"language":"promql","expression":"sum(rate(self_telemetry_dropped_total[5m]))"}}]$queries$::JSONB),
    ...
    ('molesignal-system-overview', 6, 'overview-prometheus-active-series', 'Active Prometheus series', 'Active hashed Prometheus series tracked by intake nodes.', 6, 16, 6, 16, 'stat', 'short', 0, 0, NULL, $queries$[{"refId":"A","enabled":true,"dataSourceType":"metrics","legend":"Active series","query":{"language":"promql","expression":"sum(prometheus_active_series)"}}]$queries$::JSONB),
    ...
    ('molesignal-system-overview', 9, 'overview-intake-failures', 'Intake failures & rejections', 'Flush failures and bounded intake rejection rates.', 0, 32, 12, 20, 'time_series', 'ops/s', 2, 0, NULL, $queries$[{"refId":"A","enabled":true,"dataSourceType":"metrics","legend":"{{step}}","query":{"language":"promql","expression":"sum by (step) (rate(intake_flush_errors_total[5m]))"}},{"refId":"B","enabled":true,"dataSourceType":"metrics","legend":"{{stream_type}} memory","query":{"language":"promql","expression":"sum by (stream_type) (rate(intake_memory_rejections_total[5m]))"}},{"refId":"C","enabled":true,"dataSourceType":"metrics","legend":"{{reason}} structural","query":{"language":"promql","expression":"sum by (reason) (rate(prometheus_remote_write_structural_rejections_total[5m]))"}},{"refId":"D","enabled":true,"dataSourceType":"metrics","legend":"{{reason}} admission","query":{"language":"promql","expression":"sum by (reason) (rate(prometheus_series_admission_rejections_total[5m]))"}}]$queries$::JSONB),
