...
CREATE TABLE IF NOT EXISTS iam_routes (
    ...
    CONSTRAINT chk_iam_routes_navigation
        CHECK (
            ...
            OR (
                navigation_group IN (
                    'home', 'observe', 'reliability', 'ai_ops',
                    'data', 'collaboration', 'admin'
                )
...
INSERT INTO iam_route_seed VALUES
    ...
    ('metrics', '/metrics', 'any', 'any', ARRAY[]::TEXT[], 'observe', 20, TRUE, ARRAY['streams.query', 'sys.telemetry.read']::TEXT[]),
    ('logs', '/logs', 'any', 'any', ARRAY[]::TEXT[], 'observe', 30, TRUE, ARRAY['streams.query', 'sys.telemetry.read']::TEXT[]),
    ('logs.inspector', '/logs/inspector', 'any', 'any', ARRAY[]::TEXT[], NULL, NULL, TRUE, ARRAY['streams.query', 'sys.telemetry.read']::TEXT[]),
    ('traces', '/traces', 'any', 'any', ARRAY[]::TEXT[], 'observe', 40, TRUE, ARRAY['streams.query', 'sys.telemetry.read']::TEXT[]),
    ...
    ('profiles', '/profiles', 'any', 'any', ARRAY[]::TEXT[], 'observe', 70, TRUE, ARRAY['streams.query', 'sys.telemetry.read']::TEXT[]),
    ...
    -- APM routes.
    ('apm', '/apm', 'any', 'any', ARRAY[]::TEXT[], 'observe', 50, TRUE, ARRAY['streams.query', 'sys.telemetry.read']::TEXT[]),
    ...
    ('dashboards', '/dashboards', 'any', 'any', ARRAY[]::TEXT[], 'observe', 10, TRUE, ARRAY['dashboards.read', 'sys.dashboards.read']::TEXT[]),
    ...
    ('streams', '/streams', 'any', 'any', ARRAY[]::TEXT[], 'data', 20, TRUE, ARRAY['streams.read', 'sys.telemetry.read']::TEXT[]),
    ...
    ('rum', '/rum', 'organization', 'all', ARRAY[]::TEXT[], 'observe', 60, TRUE, ARRAY['streams.query']::TEXT[]),
    ...
    ('datasource', '/datasource', 'organization', 'all', ARRAY[]::TEXT[], 'data', 10, TRUE, ARRAY['streams.query']::TEXT[]),
    ...
    ('alerts', '/alerts', 'organization', 'all', ARRAY[]::TEXT[], 'reliability', 10, TRUE, ARRAY['alerts.read']::TEXT[]),
    ('synthetics', '/synthetics/*', 'organization', 'all', ARRAY[]::TEXT[], 'reliability', 20, TRUE, ARRAY['synthetics.read']::TEXT[]),
    ('status.pages', '/status-pages', 'organization', 'all', ARRAY[]::TEXT[], 'reliability', 30, TRUE, ARRAY['status_pages.read']::TEXT[]),
    ...
    ('alerts.postmortems', '/alerts/postmortems', 'organization', 'all', ARRAY[]::TEXT[], NULL, NULL, TRUE, ARRAY['postmortems.read']::TEXT[]),
    ('saved.views', '/saved-views', 'organization', 'all', ARRAY[]::TEXT[], NULL, NULL, TRUE, ARRAY['saved_views.read']::TEXT[]),
    ('pipelines', '/pipelines', 'organization', 'all', ARRAY[]::TEXT[], 'data', 30, TRUE, ARRAY['pipelines.read']::TEXT[]),
    ...
    ('functions', '/functions', 'organization', 'all', ARRAY[]::TEXT[], 'data', 40, TRUE, ARRAY['functions.read']::TEXT[]),
    ...
    ('extend.tables', '/extend-tables', 'organization', 'all', ARRAY[]::TEXT[], 'data', 50, TRUE, ARRAY['functions.read']::TEXT[]),
    ('extend.table.detail', '/extend-tables/:table', 'organization', 'all', ARRAY[]::TEXT[], NULL, NULL, TRUE, ARRAY['functions.read']::TEXT[]),
    ('reports', '/reports', 'organization', 'all', ARRAY[]::TEXT[], 'collaboration', 10, TRUE, ARRAY['reports.read']::TEXT[]),
    ('reports.service_levels', '/reports/sla-policies', 'organization', 'all', ARRAY[]::TEXT[], NULL, NULL, TRUE, ARRAY['service_levels.read']::TEXT[]),
    ...
    ('agent', '/agent', 'organization', 'all', ARRAY['agent']::TEXT[], 'ai_ops', 10, TRUE, ARRAY['agent.use']::TEXT[]),
