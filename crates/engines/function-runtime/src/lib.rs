...
pub mod app {
    pub mod intake {
        pub use domain::function::FunctionExecutor;
    }
}
...
pub mod infra {
    pub mod runtime {
        pub use crate::{ChainedFunctionExecutor, VrlFunctionExecutor, VrlRuntime, vrl};
        #[cfg(feature = "js-runtime")]
        pub use crate::{JsFunctionExecutor, js_executor};
    }
}
