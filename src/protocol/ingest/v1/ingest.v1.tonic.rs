...
pub mod ingest_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn push(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("ingest.v1.IngestService", "Push"));
...
pub mod ingest_service_server {
    ...
    #[async_trait]
    pub trait IngestService: std::marker::Send + std::marker::Sync + 'static {
        async fn push(
            &self,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/ingest.v1.IngestService/Push" => {
                    ...
                    struct PushSvc<T: IngestService>(pub Arc<T>);
                    impl<
                        T: IngestService,
                    > tonic::server::UnaryService<super::PushRequest> for PushSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as IngestService>::push(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "ingest.v1.IngestService";
    impl<T> tonic::server::NamedService for IngestServiceServer<T> {
