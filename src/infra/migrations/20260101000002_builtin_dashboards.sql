...
VALUES
    ...
    ('544194a6-12c8-410e-8d8c-99ce409aedc8', 'molesignal-intake-storage', 'MoleSignal Intake & Storage', 'Complete intake, WAL, Parquet, object-store, compaction, and Parquet file-metadata metrics.', $tags$["built-in","molesignal","system","intake","storage"]$tags$::JSONB, 1, FALSE),
...
VALUES
    ...
    ('molesignal-intake-storage', 4, 'intake_adaptive_rotation_target_bytes', 'histogram', 'stream_type', 'bytes'),
    ...
    ('molesignal-intake-storage', 9, 'intake_parquet_encoded_raw_ratio', 'histogram', 'stream_type', 'short'),
    ('molesignal-intake-storage', 10, 'intake_rotations_total', 'counter', 'stream_type,reason', 'ops/s'),
    ('molesignal-intake-storage', 11, 'wal_append_inflight', 'gauge', 'stream_type', 'short'),
    ('molesignal-intake-storage', 12, 'wal_append_lock_wait_seconds', 'histogram', 'stream_type', 'seconds'),
    ...
    ('molesignal-intake-storage', 19, 'compactor_downsampled_groups_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 20, 'compactor_failures_total', 'counter', 'reason', 'ops/s'),
    ('molesignal-intake-storage', 21, 'compactor_merged_groups_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 22, 'compactor_retention_deleted_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 23, 'parquet_file_meta_dump_delete_partitions_dropped_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 24, 'parquet_file_meta_dump_delete_partitions_rewritten_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 25, 'parquet_file_meta_dump_partitions_skipped_total', 'counter', 'reason', 'ops/s'),
    ('molesignal-intake-storage', 26, 'parquet_file_meta_dump_partitions_written_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 27, 'parquet_file_meta_dump_query_hits_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 28, 'parquet_file_meta_dump_query_load_seconds', 'histogram', '', 'seconds'),
    ('molesignal-intake-storage', 29, 'parquet_file_meta_dump_query_rows_skipped_total', 'counter', '', 'ops/s'),
    ('molesignal-intake-storage', 30, 'parquet_file_meta_dump_rows_written_total', 'counter', '', 'ops/s'),
